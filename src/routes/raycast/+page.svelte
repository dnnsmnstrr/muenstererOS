<script lang="ts">
	...
	import { Command, HelpCircle } from 'lucide-svelte';
...
<div class="container">
	...
	<div class="mb-8">
		<p class="text-muted-foreground">
			...
			<Kbd>{Modifier.Hyper}</Kbd> means all modifier Keys are pressed (<Kbd>{hyperKeys}</Kbd>)
		</p>
	</div>
	...
	<div class="grid gap-6">
		...
		<Card.Root>
			<Card.Header>
				...
				<Card.Description>Complete list of my Raycast shortcuts</Card.Description>
			</Card.Header>
			<Card.Content>
				<div class="space-y-3">
	...
	<div class="my-8 rounded-lg border bg-muted/50 p-4">
		...
		<Link class="text-sm" href={raycastUrl} target="_blank" rel="noopener noreferrer">Learn more about the Raycast</Link>
	</div>
</div>
